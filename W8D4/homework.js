...
function setTimeout(callback){
    window.setTimeout = 5000ms;

}

function hammertime_cb(){
...
//     reader.close();
// }
// Why doesn't the above function work? Reorganize it so that it follows the outlined chronology. (Hint: we don't want to ask the user if they want biscuits until we know whether or not they want tea.Where can we situate the second reader.question ? Should we log their final response and close the reader ?)
